...
const PasswordResetSuccessScreenAndroid = () => {
      ...
      <ImageBackground source={require('../assets/images/android_login_background.png')} resizeMode='cover' style={styles.backgroundImage}>
        ...
        >
          <View style={styles.titleContainer}>
            ...
            <Text style={styles.subtitle}>Follow link in email to reset password.</Text>
          </View>
...
const PasswordResetSuccessScreenWeb = () => {
  const auth = FIREBASE_AUTH;
  const navigation = useNavigation();
      ...
      <ImageBackground source={require('../assets/images/web_login_background.jpg')} resizeMode='cover' style={webStyles.backgroundImage}>
        ...
        >
          <View style={webStyles.titleContainer}>
            <Text style={webStyles.title}>Password Reset Email Sent</Text>
            <Text style={webStyles.subtitle}>Follow link in email to reset password.</Text>
          </View>
...
if (Platform.OS === 'android') {
  exportedScreen = PasswordResetSuccessScreenAndroid 
} else if (Platform.OS === 'web') {
  exportedScreen = PasswordResetSuccessScreenWeb 
} else {
  exportedScreen = PasswordResetSuccessScreenAndroid 
}
