...
func on_document_get():
	$StateLabel.text = "User data found.  Redirecting..."
...
func on_document_error(error_code, error_status, error_message):
	$StateLabel.text = "No user data found.  Redirecting..."
	await get_tree().create_timer(1).timeout
	get_tree().change_scene_to_file("res://first_time_player/first_time_player_user_data.tscn")
	pass
